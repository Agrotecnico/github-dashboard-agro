      ...
      <div className="flex w-full px-2 h-full flex-col gap-1 max-w-[1280px] mx-auto ">
        ...
        <div className="flex gap-3 mb-3 justify-center items-center sm:flex-row sm:gap-6 ">
          ...
          {session ? (
            ...
            <CustomLink href="/dashboard" className="[text-shadow:1px_1px_0_#ffffff] duration-150 underline decoration-[#1d021555] underline-offset-2 hover:decoration-[#1d0215]">
              Panel Admin
            </CustomLink> 
              : 
              <>
