...
export default function FormConsulta({ session }: { session: Session | null }) {
  ...
  return (
    <form action={dispatch}>
      <textarea
        className="mb-4 flex max-h-40 w-full resize-y rounded border-[1px] border-[#fff0] bg-[#0000000d] p-3 italic text-gray-900 placeholder-gray-400 [box-shadow:inset_0_1px_0_#00000047,inset_0_-1px_0_#ffffffe0] 
      ...
      <div className="opacity-50 mb-4 mt-4 flex flex-col  items-center gap-3 rounded border-[1px] border-[#fff0] bg-[#0000000d] p-3 [box-shadow:inset_0_1px_0_#00000047,inset_0_-1px_0_#ffffffe0] ">
        <div className=" w-full italic text-[#11182782] ">
          adjuntar archivo...
        </div>
        <div className="flex w-full flex-col gap-4 sm:flex-row ">
          <div>
            <div className="flex flex-col text-[#374151cc] rounded items-start gap-4 bg-[#ffffff57]  min-[500px]:flex-row min-[500px]:items-center [box-shadow:inset_0_1px_#ffffffd4,inset_0_-1px_#00000047] "> {/* hover:text-[#374151] hover:bg-[#ffffff78] */}
          ...
          >
            <div className="relative flex">
              <ClipboardDocumentCheckIcon className="flex w-12 items-center justify-center stroke-1 text-[#0006] " />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-end gap-4">
        <Button
          className="bg-[#ffffff99]  text-[#000000cc] hover:bg-[#ffffffcc] hover:text-[#000] active:bg-[#fff] "
          type="submit"
        >
          Enviar
        </Button>
