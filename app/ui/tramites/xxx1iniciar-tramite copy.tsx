...
export default function IniciarTramite( {
  ...
  const [info0, setInfo0] = useState(undefined)
  const [info1, setInfo1] = useState(undefined)
  const [info2, setInfo2] = useState(undefined)
  const [info3, setInfo3] = useState(undefined)
      ...
      <form onSubmit={ files.length === 0 ? uploadToServer1 : uploadToServer2 } >
        <div className="w-full flex justify-end mt-3">
          <ButtonA
            ...
            disabled={!tramite || !polo ? true : false }
