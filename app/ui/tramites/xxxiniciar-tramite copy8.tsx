...
export default function IniciarTramite( {
  ...
  // let informacions:string[]= Array(5).fill("")
  ...
  const informations:string[]= tramiteMd.informacion?.split(", ")

  // function handleBlur(index:number, e) {
  //   if (e.target.value) {
  //     informacions[index] = `${informations[index]} : ${e.target.value}`
  //   }
  //   console.log("informacions22:", informacions)
  //   console.log("informacions:", informacions)
  // }

  // function handleFocus(index:number, e) {
  //   if (e.target.value)
  //   informacions[index] = null
  //   e.target.value = null
  // }
  ...
  useEffect(() => {
    ...
    // setInformacions(`${tramiteMd.informacions}`);
    // setInfos(informacions);
  }, [/* successState, close, */ tramiteMd, /* informacions */ ])
              ...
              {/* {informations?.map((information, index) =>  */}
                  ...
                  (<fieldset className="w-full">
                    ...
                    >
                        <div className="absolute rounded-l-[4px] h-[32px] w-[28px] left-0 top-0 bg-[#00000007]" >
                          <span className={`absolute w-3 font-semibold left-[9px] top-1.5 opacity-40 ${info0 === '' ?  "text-[#1d021599]" : "text-[#d400aadd] opacity-60"} `}>
                              &#10003;
                          </span>
                        </div>
                    </InputCnp>
                ...
                {informations[1] &&
                  (<fieldset className="w-full">
                    ...
                    >
                        <div className="absolute rounded-l-[4px] h-[32px] w-[28px] left-0 top-0 bg-[#00000007]" >
                          <span className={`absolute w-3 font-semibold left-[9px] top-1.5 opacity-40 ${info1 === '' ?  "text-[#1d021599]" : "text-[#d400aadd] opacity-60"} `}>
                              &#10003;
                          </span>
                        </div>
                    </InputCnp>
                ...
                {informations[2] &&
                  ...
                  >
                      <div className="absolute rounded-l-[4px] h-[32px] w-[28px] left-0 top-0 bg-[#00000007]" >
                        <span className={`absolute w-3 font-semibold left-[9px] top-1.5 opacity-40 ${info2 === '' ?  "text-[#1d021599]" : "text-[#d400aadd] opacity-60"} `}>
                            &#10003;
                        </span>
                      </div>
                  </InputCnp>
                ...
                {informations[3] && 
                  ...
                  >
                      <div className="absolute rounded-l-[4px] h-[32px] w-[28px] left-0 top-0 bg-[#00000007]" >
                        <span className={`absolute w-3 font-semibold left-[9px] top-1.5 opacity-40 ${info3 === '' ?  "text-[#1d021599]" : "text-[#d400aadd] opacity-60"} `}>
                            &#10003;
                        </span>
                      </div>
                  </InputCnp>
         ...
         polo === null || polo !== "usuario" && polox === "Database Error: El email ya existe." ? (
          <Frente className="py-4 px-3 mt-2 text-small-regular sm:px-4 !bg-[#1d021513] ">
            <div className="flex items-center justify-between gap-5">
              ...
              <div className={`w-full text-start text-[14px] text-[#50073aaa] transition-[opacity] duration-300  ${statex ? "opacity-100" : "opacity-0 hidden"  } `}>
