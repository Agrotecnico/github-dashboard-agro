...
export default async function RevenueChart() {
  ...
  return (
    <div className="w-full md:col-span-4">
      ...
      <div className="">
        <Frente className="bg-[#30032210] !mb-1 sm:grid-cols-13 mt-0 grid grid-cols-12 items-end gap-2 p-4 md:gap-4 min-[1024px]:[grid-template-columns:_auto_repeat(12,_minmax(0,_1fr))] min-[1024px]:gap-1.5 ">
          <div
            className="mb-6 hidden flex-col justify-between text-xs text-[#1d021599] sm:flex"
